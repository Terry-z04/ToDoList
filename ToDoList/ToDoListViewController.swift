...
//  ToDoList
//
//  Created by Terry Zhuang on 2/25/21.
//
...
class ToDoListViewController: UIViewController {
    ...
    var toDoArray = ["Learn Swift", "Oh My God", "Build Apps", "Change The World"]
...
extension ToDoListViewController: UITableViewDelegate, UITableViewDataSource {
    func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        print("😎 numberOfRowInSection was just called. Returning \(toDoArray.count)")
    ...
    func tableView(_ tableView: UITableView, moveRowAt sourceIndexPath: IndexPath, to destinationIndexPath: IndexPath) {
        ...
        toDoArray.insert(itemToMove, at: sourceIndexPath.row)
    }
